...
import 'package:tall/ui/shared/metricswidget.dart';
      ...
      child: Row(
        ...
        children: <Widget>[
          Column(children: <Widget>[
            MetricsWidget(
              metricsWidgetTitle: 'Cash In Hand',
              metricsWidget: 'cash_in_hand',
            )
          ]),
          Column(
            children: <Widget>[
              MetricsWidget(
                metricsWidgetTitle: 'Cash In Bank',
                metricsWidget: 'cash_in_bank',
              )
            ],
          )
        ],
