...
import 'package:tall/core/models/voucher-item.dart';
import 'package:tall/core/services/storageservice.dart';
import 'package:tall/core/services/voucher-item-service.dart';
import 'package:tall/core/services/vouchers.dart';
import 'package:tall/templates/invoice_pdf_template.dart';
...
import 'package:tall/ui/widgets/productcard.dart';
  ...
  if (preview) {
    ...
    try {
      ...
      await Share.files(
          ...
          '*/*',
          text:
              'Please find $invoiceNumber worth $totalAmount from $company. It was great doing business with you! - shared via GJAMAssist');
    } catch (e) {
      print('error: $e');
    }
  }
